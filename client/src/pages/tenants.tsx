...
export default function TenantsPage() {
  return (
    <WorkspaceShell title="Tenants" eyebrow="Operations">
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="mt-0.5 font-display text-[18px] font-semibold tracking-tight text-fg">
                Tenant companies, contacts, health
              </div>
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="font-body text-[13px] font-semibold text-fg">{tenant.name}</p>
                    <p className="mt-0.5 font-body text-[12px] text-fg-muted">Primary contact: {tenant.contact}</p>
                    ...
                    <p className="mt-2 font-body text-[12px] text-fg-muted">{tenant.note}</p>
                  </div>
                </div>
              </article>
            ))}
        ...
        <Card variant="dashed" padding="md" as="aside">
          ...
          <ul className="mt-3 space-y-2 font-body text-[13px] leading-[1.55] text-fg-muted">
            <li>· Per-tenant timelines and linked conversation history</li>
            <li>· Organization metadata, tags, ownership, lifecycle state</li>
            <li>· Tenant detail routes with relationship health + lease context</li>
          </ul>
        </Card>
      </div>
    </WorkspaceShell>
